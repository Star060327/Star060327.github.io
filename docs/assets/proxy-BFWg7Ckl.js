import { r as S, j as he } from './index-PyI2GaQq.js';
const Vs = S.createContext({});
function or(t) {
  const e = S.useRef(null);
  return (e.current === null && (e.current = t()), e.current);
}
const Fe = typeof window < 'u',
  ar = Fe ? S.useLayoutEffect : S.useEffect,
  Be = S.createContext(null);
function Ie(t, e) {
...
class Ue {
  ...
  add(e) {
    return (Ie(this.subscriptions, e), () => je(this.subscriptions, e));
  }
  notify(e, n, s) {
...
const Rs = (t, e, n) => (((1 - 3 * n + 3 * e) * t + (3 * n - 6 * e)) * t + 3 * e) * t,
  ur = 1e-7,
  cr = 12;
function hr(t, e, n, s, i) {
  let o,
    r,
    a = 0;
  do ((r = e + (n - e) / 2), (o = Rs(r, s, i) - t), o > 0 ? (n = r) : (e = r));
  while (Math.abs(o) > ur && ++a < cr);
  return r;
}
function Rt(t, e, n, s) {
  if (t === e && n === s) return W;
  const i = (o) => hr(o, 0, 1, t, n);
  return (o) => (o === 0 || o === 1 ? o : Rs(i(o), e, s));
}
const Ls = (t) => (e) => (e <= 0.5 ? t(2 * e) / 2 : (2 - t(2 * (1 - e))) / 2),
  ks = (t) => (e) => 1 - t(1 - e),
  Fs = Rt(0.33, 1.53, 0.69, 0.99),
  Ke = ks(Fs),
  Bs = Ls(Ke),
  Is = (t) => ((t *= 2) < 1 ? 0.5 * Ke(t) : 0.5 * (2 - Math.pow(2, -10 * (t - 1)))),
  ...
  dr = Rt(0, 0, 0.58, 1),
  Ns = Rt(0.42, 0, 0.58, 1),
  mr = (t) => Array.isArray(t) && typeof t[0] != 'number',
  Us = (t) => Array.isArray(t) && typeof t[0] == 'number',
  pr = {
    linear: W,
    easeIn: fr,
    easeInOut: Ns,
...
function Ks(t, e) {
  ...
  const i = { delta: 0, timestamp: 0, isProcessing: !1 },
    ...
    v = () => {
      ...
      ((n = !1),
        X.useManualTiming || (i.delta = s ? 1e3 / 60 : Math.max(Math.min(g - i.timestamp, vr), 1)),
        (i.timestamp = g),
        (i.isProcessing = !0),
        a.process(i),
        l.process(i),
...
const {
  ...
  state: k,
  steps: qt
} = Ks(typeof requestAnimationFrame < 'u' ? requestAnimationFrame : W, !0);
let jt;
function Tr() {
  jt = void 0;
}
const j = {
    now: () => (
      jt === void 0 && j.set(k.isProcessing || X.useManualTiming ? k.timestamp : performance.now()),
      jt
    ),
    set: (t) => {
  ...
  Ws = (t) => (e) => typeof e == 'string' && e.startsWith(t),
  $s = Ws('--'),
  xr = Ws('var(--'),
  $e = (t) => (xr(t) ? Pr.test(t.split('/*')[0].trim()) : !1),
  Pr = /var\(--(?:[\w-]+\s*|[\w-]+\s*,(?:\s*[^)(\s]|\s*\((?:[^)(]|\([^)(]*\))*\))+\s*)\)$/iu,
  gt = { test: (t) => typeof t == 'number', parse: parseFloat, transform: (t) => t },
  Vt = { ...gt, transform: (t) => z(0, 1, t) },
  Bt = { ...gt, default: 1 },
...
const br =
  ...
  He = (t, e) => (n) =>
    !!(
      (typeof n == 'string' && br.test(n) && n.startsWith(t)) ||
      (e && !Sr(n) && Object.prototype.hasOwnProperty.call(n, e))
    ),
  Gs = (t, e, n) => (s) => {
  ...
  Ar = (t) => z(0, 255, t),
  Zt = { ...gt, transform: (t) => Math.round(Ar(t)) },
  nt = {
    test: He('rgb', 'red'),
...
const fe = { test: He('#'), parse: wr, transform: nt.transform },
  Lt = (t) => ({
  ...
  Vr = Lt('vh'),
  Cr = Lt('vw'),
  gn = { ..._, parse: (t) => _.parse(t) / 100, transform: (t) => _.transform(t * 100) },
  lt = {
    test: He('hsl', 'hue'),
  ...
  D = {
    ...
    transform: (t) =>
      typeof t == 'string' ? t : t.hasOwnProperty('red') ? nt.transform(t) : lt.transform(t),
    getAnimatableNone: (t) => {
      const e = D.parse(t);
...
function Dr(t) {
  return (
    isNaN(t) && typeof t == 'string' && (t.match(Ge)?.length || 0) + (t.match(Mr)?.length || 0) > 0
  );
}
const Hs = 'number',
  _s = 'color',
...
function Ct(t) {
  ...
  const a = e
    .replace(
      ...
      (l) => (
        D.test(l)
          ? (s.color.push(o), i.push(_s), n.push(D.parse(l)))
          : l.startsWith(Rr)
            ? (s.var.push(o), i.push(Er), n.push(l))
            : (s.number.push(o), i.push(Hs), n.push(parseFloat(l))),
        ++o,
        yn
      )
    )
...
function Xs(t) {
  ...
  return (i) => {
    ...
    for (let r = 0; r < s; r++)
      if (((o += e[r]), i[r] !== void 0)) {
        const a = n[r];
        a === Hs ? (o += Pt(i[r])) : a === _s ? (o += D.transform(i[r])) : (o += i[r]);
      }
    return o;
  };
}
...
function Fr(t) {
  const e = zs(t);
  return Xs(t)(e.map(kr));
}
const Z = { test: Dr, parse: zs, createTransformer: Xs, getAnimatableNone: Fr };
function Jt(t, e, n) {
  return (
    n < 0 && (n += 1),
    n > 1 && (n -= 1),
...
function Br({ hue: t, saturation: e, lightness: n, alpha: s }) {
  ((t /= 360), (e /= 100), (n /= 100));
  let i = 0,
    o = 0,
    r = 0;
...
const Tn = (t, e) => {
    ...
    const i = { ...n };
    return (o) => (
      (i.red = Qt(n.red, s.red, o)),
      (i.green = Qt(n.green, s.green, o)),
      (i.blue = Qt(n.blue, s.blue, o)),
...
function Gr(t, e = 100, n) {
  const s = n({ ...t, keyframes: [0, e] }),
    i = Math.min(ze(s), Wt);
  return { type: 'keyframes', ease: (o) => s.next(i * o).value / e, duration: K(i) };
}
const Hr = 5;
function Js(t, e, n) {
...
function _r({
  ...
  let i,
    o,
    r = 1 - e;
  ((r = z(M.minDamping, M.maxDamping, r)),
    (t = z(M.minDuration, M.maxDuration, K(t))),
    r < 1
      ? ((i = (c) => {
          const u = c * r,
            h = u * t,
  ...
  const a = 5 / t,
    l = Xr(i, o, a);
  if (((t = H(t)), isNaN(l))) return { stiffness: M.stiffness, damping: M.damping, duration: t };
  {
...
function Qr(t, e, { clamp: n = !0, ease: s, mixer: i } = {}) {
  const o = t.length;
  if ((Oe(o === e.length), o === 1)) return () => e[0];
...
function St({ duration: t = 300, keyframes: e, times: n, ease: s = 'easeInOut' }) {
  const i = mr(s) ? s.map(pn) : pn(s),
    o = { done: !1, value: e[0] },
    r = no(n && n.length === e.length ? n : eo(e), t),
    a = Qr(r, e, { ease: Array.isArray(i) ? i : so(e, i) });
...
const ro = { decay: pe, inertia: pe, tween: St, keyframes: St, spring: $t };
function Qs(t) {
...
class qe extends Ye {
  ...
  initAnimation() {
    ...
    l !== St &&
      typeof a[0] != 'number' &&
      ((this.mixKeyframes = Et(oo, qs(a[0], a[1]))), (a = [0, 100]));
  ...
  tick(e, n = !1) {
    ...
    if (h) {
      ...
      (!O && b >= 1 && (O = 1),
        ...
        (I = Math.min(I, h + 1)),
        !!(I % 2) &&
          (f === 'reverse' ? ((O = 1 - O), d && (O -= d / a)) : f === 'mirror' && (A = r)),
        (g = z(0, 1, O) * a));
    }
    ...
    !T &&
      l !== null &&
      (w = this.playbackSpeed >= 0 ? this.currentTime >= i : this.currentTime <= 0);
    const E =
      this.holdTime === null && (this.state === 'finished' || (this.state === 'running' && w));
    return (
      E && m !== pe && (P.value = Xe(u, this.options, y, this.speed)),
      v && v(P.value),
      E && this.finish(),
      P
    );
  ...
  play() {
    ...
    const { driver: e = $r, startTime: n } = this.options;
...
const st = (t) => (t * 180) / Math.PI,
  ...
  Pn = ge,
  Sn = (t) => Math.sqrt(t[0] * t[0] + t[1] * t[1]),
...
class Ze {
  ...
  scheduleResolve() {
    ((this.state = 'scheduled'),
      this.isAsync
        ? (rt.add(this), xe || ((xe = !0), V.read(ei), V.resolveKeyframes(ti)))
...
const To = Ne(() => window.ScrollTimeline !== void 0),
  xo = {};
function Po(t, e) {
  const n = Ne(t);
  return () => xo[e] ?? n();
...
class Ao extends Ye {
  constructor(e) {
    ...
    ((this.isPseudoElement = !!o),
      (this.allowFlatten = r),
      (this.options = e),
      Oe(typeof e.type != 'string'));
    const c = bo(e);
    ((this.animation = So(n, s, i, c, o)),
      c.autoplay === !1 && this.animation.pause(),
      (this.animation.onfinish = () => {
        if (((this.finishedTime = this.time), !o)) {
          const u = Xe(i, this.options, a, this.speed);
          (this.updateMotionValue ? this.updateMotionValue(u) : vo(n, s, u),
  ...
  attachTimeline({ timeline: e, observe: n }) {
    return (
      ...
      e && To() ? ((this.animation.timeline = e), W) : n(this)
    );
  }
}
const ri = { anticipate: Is, backInOut: Bs, circInOut: Os };
function wo(t) {
  return t in ri;
}
function Vo(t) {
  typeof t.ease == 'string' && wo(t.ease) && (t.ease = ri[t.ease]);
}
const Vn = 10;
class Co extends Ao {
  constructor(e) {
    (Vo(e), Qs(e), super(e), e.startTime && (this.startTime = e.startTime), (this.options = e));
  }
  updateMotionValue(e) {
    ...
    const a = new qe({ ...r, autoplay: !1 }),
      l = H(this.finishedTime ?? this.time);
    (n.setWithVelocity(a.sample(l - Vn).value, a.sample(l).value, Vn), a.stop());
  }
}
const Cn = (t, e) =>
  e === 'zIndex'
...
function Do(t, e, n, s) {
  ...
  const o = t[t.length - 1],
    r = Cn(i, e),
    a = Cn(o, e);
  return !r || !a ? !1 : Mo(t) || ((n === 'spring' || ii(n)) && s);
}
function be(t) {
  ((t.duration = 0), (t.type = 'keyframes'));
}
const Eo = new Set(['opacity', 'clipPath', 'filter', 'transform']),
  Ro = Ne(() => Object.hasOwnProperty.call(Element.prototype, 'animate'));
function Lo(t) {
...
class Fo extends Ye {
  ...
  onKeyframesResolved(e, n, s, i) {
    ...
    ((this.resolvedAt = j.now()),
      Do(e, o, r, a) ||
        ((X.instantAnimations || !l) && u?.(Xe(e, s, n)),
        (e[0] = e[e.length - 1]),
        be(s),
        (s.repeat = 0)));
    const f = {
        startTime: i
          ? this.resolvedAt
            ? this.resolvedAt - this.createdAt > ko
              ? this.resolvedAt
              : this.createdAt
            : this.createdAt
          : void 0,
      ...
      d = !c && Lo(f) ? new Co({ ...f, element: f.motionValue.owner.current }) : new qe(f);
...
function oi(t, e, n = 1) {
  ...
  if (o) {
    const r = o.trim();
    return Cs(r) ? parseFloat(r) : r;
  }
  return $e(i) ? oi(i, e, n + 1) : i;
}
function Je(t, e) {
  return t?.[e] ?? t?.default ?? t;
}
const ai = new Set(['width', 'height', 'top', 'left', 'right', 'bottom', ...yt]),
  jo = { test: (t) => t === 'auto', parse: (t) => t },
  li = (t) => (e) => e.test(t),
  ui = [gt, x, _, Y, Cr, Vr, jo],
  Mn = (t) => ui.find(li(t));
function Oo(t) {
  return typeof t == 'number' ? t === 0 : t !== null ? t === 'none' || t === '0' || Ds(t) : !0;
}
...
function Ho(t, e, n) {
  ...
  for (; s < t.length && !i; ) {
    const o = t[s];
    (typeof o == 'string' && !Go.has(o) && Ct(o).values.length && (i = t[s]), s++);
  }
...
class _o extends Ze {
  ...
  readKeyframes() {
    ...
    for (let l = 0; l < e.length; l++) {
      ...
      if (typeof c == 'string' && ((c = c.trim()), $e(c))) {
        const u = oi(c, n.current);
        (u !== void 0 && (e[l] = u), l === e.length - 1 && (this.finalKeyframe = c));
      }
    }
    if ((this.resolveNoneKeyframes(), !ai.has(s) || e.length !== 2)) return;
    const [i, o] = e,
      r = Mn(i),
      a = Mn(o);
    if (r !== a)
  ...
  measureEndState() {
    ...
    const o = s.length - 1,
      r = s[o];
    ((s[o] = it[n](e.measureViewportBox(), window.getComputedStyle(e.current))),
...
class qo {
  ...
  setCurrent(e) {
    ((this.current = e),
      ...
      this.canTrackVelocity === null && e !== void 0 && (this.canTrackVelocity = Yo(this.current)));
  }
...
const { schedule: tn } = Ks(queueMicrotask, !1),
  G = { x: !1, y: !1 };
function di() {
  return G.x || G.y;
}
...
function Jo(t, e, n = {}) {
  const [s, i, o] = mi(t, n),
    r = (a) => {
      ...
      const u = (h) => {
        Rn(h) && (c(h), l.removeEventListener('pointerleave', u));
      };
      ...
      const c = e(l, a),
        u = (d, m) => {
          (window.removeEventListener('pointerup', h),
            ...
            Ot.has(l) && Ot.delete(l),
            kn(d) && typeof c == 'function' && c(d, { success: m }));
        },
        h = (d) => {
          u(d, l === window || l === document || n.useGlobalTarget || pi(l, d.target));
        },
        f = (d) => {
          u(d, !1);
        };
  ...
  return (
    s.forEach((a) => {
      ((n.useGlobalTarget ? window : a).addEventListener('pointerdown', r, i),
        Xo(a) &&
          (a.addEventListener('focus', (c) => ea(c, i)),
...
function sa(t) {
  return gi(t) && t.tagName === 'svg';
}
const F = (t) => !!(t && t.getVelocity),
  ia = [...ui, D, Z],
  ra = (t) => ia.find(li(t)),
  yi = S.createContext({ transformPagePoint: (t) => t, isStatic: !1, reducedMotion: 'never' });
function oa(t = !0) {
...
const vi = S.createContext({ strict: !1 }),
  Fn = {
    animation: [
      'animate',
      'variants',
  ...
  pt = {};
for (const t in Fn) pt[t] = { isEnabled: (e) => Fn[t].some((n) => !!e[n]) };
function aa(t) {
...
let Ti = (t) => !Gt(t);
function ua(t) {
  typeof t == 'function' && (Ti = (e) => (e.startsWith('on') ? !Gt(e) : t(e)));
}
try {
...
const nn = ['animate', 'whileInView', 'whileFocus', 'whileHover', 'whileTap', 'whileDrag', 'exit'],
  sn = ['initial', ...nn];
function Yt(t) {
  return Xt(t.animate) || sn.some((e) => Mt(t[e]));
}
function xi(t) {
...
function fa(t) {
  const { initial: e, animate: n } = ha(t, S.useContext(zt));
  return S.useMemo(() => ({ initial: e, animate: n }), [Bn(e), Bn(n)]);
}
function Bn(t) {
...
function Pi(t, { layout: e, layoutId: n }) {
  return (
    vt.has(t) || t.startsWith('origin') || ((e || n !== void 0) && (!!we[t] || t === 'opacity'))
  );
}
const ma = {
    x: 'translateX',
...
function rn(t, e, n) {
  ...
  if (
    (e.transform ||
      (r || n ? (s.transform = ga(e, t.transform, n)) : s.transform && (s.transform = 'none')),
    a)
  ) {
...
function Si(t, e, n) {
  for (const s in e) !F(e[s]) && !Pi(s, n) && (t[s] = e[s]);
}
function ya({ transformTemplate: t }, e) {
  return S.useMemo(() => {
    const n = on();
...
function va(t, e) {
  const n = t.style || {},
    s = {};
  return (Si(s, n, t), Object.assign(s, ya(t, e)), s);
}
function Ta(t, e) {
  const n = {},
    s = va(t, e);
...
const xa = { offset: 'stroke-dashoffset', array: 'stroke-dasharray' },
  Pa = { offset: 'strokeDashoffset', array: 'strokeDasharray' };
...
function bi(
  ...
  (h.transform && ((f.transform = h.transform), delete h.transform),
    ...
    f.transform && ((f.transformBox = u?.transformBox ?? 'fill-box'), delete h.transformBox),
    e !== void 0 && (h.x = e),
    n !== void 0 && (h.y = n),
    s !== void 0 && (h.scale = s),
    i !== void 0 && Sa(h, i, o, r, !1));
}
const Ai = () => ({ ...on(), attrs: {} }),
...
function ba(t, e, n, s) {
  const i = S.useMemo(() => {
    const o = Ai();
    return (bi(o, e, wi(s), t.transformTemplate, t.style), { ...o.attrs, style: { ...o.style } });
  }, [e]);
  if (t.style) {
    const o = {};
...
function an(t) {
  return typeof t != 'string' || t.includes('-') ? !1 : !!(Aa.indexOf(t) > -1 || /[A-Z]/u.test(t));
}
function wa(t, e, n, { latestValues: s }, i, o = !1) {
  const a = (an(t) ? ba : Ta)(e, s, i, t),
    l = ca(e, typeof t == 'string', o),
...
function Va({ scrapeMotionValuesFromProps: t, createRenderState: e }, n, s, i) {
  return { latestValues: Ca(n, s, i, t), renderState: e() };
}
function Ca(t, e, n, s) {
  const i = {},
    o = s(t, {});
...
function un(t, e, n) {
  const { style: s } = t,
    i = {};
  for (const o in s)
    (F(s[o]) || (e.style && F(e.style[o])) || Pi(o, t) || n?.getValue(o)?.liveStyle !== void 0) &&
      (i[o] = s[o]);
  return i;
}
const Ma = Vi({ scrapeMotionValuesFromProps: un, createRenderState: on });
function Ci(t, e, n) {
  const s = un(t, e, n);
  for (const i in t)
    if (F(t[i]) || F(e[i])) {
...
const Da = Vi({ scrapeMotionValuesFromProps: Ci, createRenderState: Ai }),
  ...
  return S.useCallback(
    (s) => {
      (s && t.onMount && t.onMount(s),
        ...
        n && (typeof n == 'function' ? n(s) : ut(n) && (n.current = s)));
    },
    [e]
  );
}
const cn = (t) => t.replace(/([a-z])([A-Z])/gu, '$1-$2').toLowerCase(),
  ...
  Mi = 'data-' + cn(La),
  Di = S.createContext({});
function ka(t, e, n, s, i) {
  const { visualElement: o } = S.useContext(zt),
    r = S.useContext(vi),
    a = S.useContext(Be),
    l = S.useContext(yi).reducedMotion,
    c = S.useRef(null);
  ((s = s || r.renderer),
    !c.current &&
      s &&
  ...
  const u = c.current,
    h = S.useContext(Di);
  u && !u.projection && i && (u.type === 'html' || u.type === 'svg') && Fa(c.current, n, i, h);
  const f = S.useRef(!1);
...
function Fa(t, e, n, s) {
  ...
  ((t.projection = new n(t.latestValues, e['data-framer-portal-id'] ? void 0 : Ei(t.parent))),
...
function ne(t, { forwardMotionProps: e = !1 } = {}, n, s) {
  n && aa(n);
  const i = an(t) ? Da : Ma;
  function o(a, l) {
    let c;
    const u = { ...S.useContext(yi), ...a, layoutId: Ba(a) },
      { isStatic: h } = u,
      f = fa(a),
      d = i(a, h);
    if (!h && Fe) {
      Ia();
      const m = ja(u);
      ((c = m.MeasureLayout), (f.visualElement = ka(t, d, u, s, m.ProjectionNode)));
    }
    return he.jsxs(zt.Provider, {
      value: f,
      children: [
        c && f.visualElement ? he.jsx(c, { visualElement: f.visualElement, ...u }) : null,
        wa(t, a, Ra(d, f.visualElement, l), d, h, e)
      ]
    });
  }
...
function Ba({ layoutId: t }) {
  const e = S.useContext(Vs).id;
  return e && t !== void 0 ? e + '-' + t : t;
}
function Ia(t, e) {
  S.useContext(vi).strict;
}
function ja(t) {
...
function Ri({ top: t, left: e, right: n, bottom: s }) {
  ...
  for (let a = 0; a < i; a++) {
    ...
    (l && l.props.style && l.props.style.display === 'contents') ||
      (s &&
        ...
        o.scroll &&
        o !== o.root &&
        ht(t, { x: -o.scroll.offset.x, y: -o.scroll.offset.y }),
      r && ((e.x *= r.x.scale), (e.y *= r.y.scale), ki(t, r)),
      s && et(o.latestValues) && ht(t, o.latestValues));
  }
...
function Fi(t, e) {
  return Ri(Ua(t.getBoundingClientRect(), e));
}
function Wa(t, e, n) {
  const s = Fi(t, n),
    { scroll: i } = e;
...
const $n = () => ({ translate: 0, scale: 1, origin: 0, originPoint: 0 }),
  ft = () => ({ x: $n(), y: $n() }),
  Gn = () => ({ min: 0, max: 0 }),
  R = () => ({ x: Gn(), y: Gn() }),
  Me = { current: null },
...
class _a {
  ...
  readValue(e, n) {
    ...
    return (
      s != null &&
        (typeof s == 'string' && (Cs(s) || Ds(s))
          ? (s = parseFloat(s))
          : !ra(s) && Z.test(n) && (s = hi(e, n)),
  ...
  on(e, n) {
    return (this.events[e] || (this.events[e] = new Ue()), this.events[e].add(n));
  }
  notify(e, ...n) {
...
class Xa extends Ii {
  ...
  readValueFromInstance(e, n) {
    ...
    {
      const s = za(e),
        i = ($s(n) ? s.getPropertyValue(n) : s[n]) || 0;
...
const Za = (t, e) => (an(t) ? new qa(e) : new Xa(e, { allowProjection: t !== S.Fragment }));
function dt(t, e, n) {
  const s = t.getProps();
...
const nl = (t) => t !== null;
function sl(t, { repeat: e, repeatType: n = 'loop' }, s) {
  const i = t.filter(nl),
...
const il = { type: 'spring', stiffness: 500, damping: 25, restSpeed: 10 },
  ...
  ol = { type: 'keyframes', duration: 0.8 },
  al = { type: 'keyframes', ease: [0.25, 0.1, 0.35, 1], duration: 0.3 },
  ll = (t, { keyframes: e }) =>
    e.length > 2 ? ol : vt.has(t) ? (t.startsWith('scale') ? rl(e[1]) : il) : al;
function ul({
  when: t,
  delay: e,
  delayChildren: n,
  ...
  (r) => {
    ...
    if (
      ((u.type === !1 || (u.duration === 0 && !u.repeatDelay)) &&
        (be(u), u.delay === 0 && (h = !0)),
      (X.instantAnimations || X.skipAnimations) && ((h = !0), be(u), (u.delay = 0)),
      (u.allowFlatten = !a.type && !a.ease),
      h && !o && e.get() !== void 0)
    ) {
      const f = sl(u.keyframes, a);
      if (f !== void 0) {
        V.update(() => {
...
function Ui(t, e, { delay: n = 0, transitionOverride: s, type: i } = {}) {
  ...
  for (const u in a) {
    const h = t.getValue(u, t.latestValues[u] ?? null),
      f = a[u];
    if (f === void 0 || (c && cl(c, u))) continue;
    const d = { delay: n, ...Je(o || {}, u) },
      m = h.get();
    ...
    (Ee(t, u), h.start(hn(u, h, f, t.shouldReduceMotion && ai.has(u) ? { type: !1 } : d, t, v)));
    const y = h.animation;
    y && l.push(y);
  }
  return (
...
function hl(t, e, n = 0, s = 0, i = 0, o = 1, r) {
  const a = [];
...
const ml = [...nn].reverse(),
  pl = nn.length;
function gl(t) {
  return (e) => Promise.all(e.map(({ animation: n, options: s }) => fl(t, n, s)));
}
function yl(t) {
  let e = gl(t),
    n = _n(),
  ...
  function r(l) {
    ...
    for (let y = 0; y < pl; y++) {
      ...
      if (
        ...
        (T.protectedKeys = { ...d }),
        (!T.isActive && P === null) || (!g && !T.prevProp) || Xt(g) || typeof g == 'boolean')
      )
        continue;
      const E = vl(T.prevProp, g);
      let b = E || (p === l && T.isActive && !w && A) || (y > m && A),
        I = !1;
      const O = Array.isArray(g) ? g : [g];
      let ot = O.reduce(i(p), {});
      P === !1 && (ot = {});
      const { prevResolvedValues: fn = {} } = T,
        ir = { ...fn, ...ot },
        dn = (L) => {
          ...
          ...O.map((L) => {
            ...
            if (typeof L == 'string' && s && !mn && t.manuallyAnimateOnMount && t.parent) {
              ...
              if (Q.enteringChildren && at) {
                const { delayChildren: rr } = at.transition || {};
    ...
    let v = !!h.length;
    return (
      s && (c.initial === !1 || c.initial === c.animate) && !t.manuallyAnimateOnMount && (v = !1),
      (s = !1),
...
const Sl = { animation: { Feature: Tl }, exit: { Feature: Pl } };
...
const bl = (t) => (e) => en(e) && t(e, kt(e));
function bt(t, e, n, s) {
  return Dt(t, e, bl(n), s);
}
const Gi = 1e-4,
  Al = 1 - Gi,
  wl = 1 + Gi,
...
function zn(t, e, n, s = 0.5) {
  ((t.origin = s),
    ...
    ((t.scale >= Al && t.scale <= wl) || isNaN(t.scale)) && (t.scale = 1),
    ((t.translate >= Vl && t.translate <= Cl) || isNaN(t.translate)) && (t.translate = 0));
}
function At(t, e, n, s) {
    ...
    if (
      ...
      (this.updatePoint = () => {
        ...
        const f = re(this.lastMoveEventInfo, this.history),
          ...
          m = El(f.offset, { x: 0, y: 0 }) >= this.distanceThreshold;
        if (!d && !m) return;
        const { point: v } = f,
          { timestamp: y } = k;
        this.history.push({ ...v, timestamp: y });
        const { onStart: p, onMove: T } = this.handlers;
        (d || (p && p(this.lastMoveEvent, f), (this.startEvent = this.lastMoveEvent)),
          T && T(this.lastMoveEvent, f));
      }),
      (this.handlePointerMove = (f, d) => {
        ((this.lastMoveEvent = f),
          (this.lastMoveEventInfo = ie(d, this.transformPagePoint)),
      ...
      (this.handlePointerUp = (f, d) => {
        ...
        if ((this.dragSnapToOrigin && y && y(), !(this.lastMoveEvent && this.lastMoveEventInfo)))
          return;
        const p = re(
          f.type === 'pointercancel' ? this.lastMoveEventInfo : ie(d, this.transformPagePoint),
          this.history
        );
...
function re({ point: t }, e) {
  return { point: t, delta: Zn(t, Xi(e)), offset: Zn(t, Rl(e)), velocity: Ll(e, 0.1) };
}
function Rl(t) {
  return t[0];
}
...
function Fl(t, { top: e, left: n, bottom: s, right: i }) {
  return { x: Jn(t.x, n, i), y: Jn(t.y, e, s) };
}
function Qn(t, e) {
  let n = e.min - t.min,
    s = e.max - t.max;
...
function Il(t, e) {
  ...
  const s = B(t),
    i = B(e);
  return (
    i > s ? (n = wt(e.min, e.max - s, t.min)) : s > i && (n = wt(t.min, t.max - i, e.min)),
    z(0, 1, n)
  );
}
function jl(t, e) {
...
function Ol(t = Le) {
  return (
    t === !1 ? (t = 0) : t === !0 && (t = Le),
    { x: ts(t, 'left', 'right'), y: ts(t, 'top', 'bottom') }
  );
}
function ts(t, e, n) {
  return { min: es(t, e), max: es(t, n) };
}
function es(t, e) {
...
class Ul {
    ...
    const o = (h) => {
      ...
      r = (h, f) => {
        ...
        ((this.latestPointerEvent = h),
          ...
          Ee(this.visualElement, 'transform'));
      ...
      c = () =>
        U(
          (h) =>
            this.getAnimationState(h) === 'paused' && this.getAxisMotionValue(h).animation?.play()
        ),
      { dragSnapToOrigin: u } = this.getProps();
    this.panSession = new zi(
      e,
      { onSessionStart: o, onStart: r, onMove: a, onSessionEnd: l, resumeAnimation: c },
      {
  ...
  updateAxis(e, n, s) {
    ...
    (this.constraints && this.constraints[e] && (r = kl(r, this.constraints[e], this.elastic[e])),
      o.set(r));
  }
  resolveConstraints() {
    ...
    (e && ut(e)
      ...
      : e && s
        ? (this.constraints = Fl(s.layoutBox, e))
        : (this.constraints = !1),
      (this.elastic = Ol(n)),
      i !== this.constraints &&
        s &&
        ...
        U((o) => {
          this.constraints !== !1 &&
            ...
            (this.constraints[o] = jl(s.layoutBox[o], this.constraints[o]));
        }));
  }
  resolveRefConstraints() {
    ...
    const o = Wa(s, i.root, this.visualElement.getTransformPagePoint());
  ...
  scalePositionWithinConstraints() {
    ...
    U((r) => {
      ...
      if (a && this.constraints !== !1) {
        const l = a.get();
        i[r] = Il({ min: l, max: l }, this.constraints[r]);
      }
    });
...
function ql(t, e, n, s, i, o) {
  i
    ? ((t.opacity = C(0, n.opacity ?? 1, Zl(s))), (t.opacityExit = C(e.opacity ?? 1, 0, Jl(s))))
  ...
  for (let r = 0; r < Yl; r++) {
    ...
    (l || (l = 0),
      c || (c = 0),
      l === 0 || c === 0 || is(l) === is(c)
        ? ((t[a] = Math.max(C(ss(l), ss(c), s), 0)), (_.test(c) || _.test(l)) && (t[a] += '%'))
        : (t[a] = c));
  }
...
function Ql(t, e = 0, n = 1, s = 0.5, i, o = t, r = t) {
  if (
...
function us(t, e, [n, s, i], o, r) {
  Ql(t, e[n], e[s], e[i], e.scale, o, r);
}
const tu = ['x', 'scaleX', 'originX'],
  eu = ['y', 'scaleY', 'originY'];
function cs(t, e, n, s) {
  (us(t.x, e, tu, n ? n.x : void 0, s ? s.x : void 0),
    us(t.y, e, eu, n ? n.y : void 0, s ? s.y : void 0));
}
function hs(t) {
...
function er({
  ...
  return class {
    ...
    addEventListener(r, a) {
      return (
        this.eventHandlers.has(r) || this.eventHandlers.set(r, new Ue()),
    ...
    mount(r) {
      ...
      ((this.isSVG = gi(r) && !sa(r)), (this.instance = r));
          ...
          t(r, () => {
            ...
            d !== h &&
              ...
              Ut.hasAnimatedSinceResize &&
                ((Ut.hasAnimatedSinceResize = !1), this.nodes.forEach(vs)));
          }));
      }
        ...
        this.options.animate !== !1 &&
          ...
          this.addEventListener(
            ...
            ({ delta: u, hasLayoutChanged: h, hasRelativeLayoutChanged: f, layout: d }) => {
              ...
              const m = this.options.transition || c.getDefaultTransition() || Tu,
                { onLayoutAnimationStart: v, onLayoutAnimationComplete: y } = c.getProps(),
              ...
              if (
                ...
                const g = { ...Je(m, 'layout'), onPlay: v, onComplete: y };
    ...
    startUpdate() {
      this.isUpdateBlocked() ||
        ((this.isUpdating = !0), this.nodes && this.nodes.forEach(pu), this.animationId++);
    }
    ...
    willUpdate(r = !0) {
      ...
      if (
        (window.MotionCancelOptimisedAnimation && !this.hasCheckedOptimisedAppear && tr(this),
    ...
    update() {
      ...
      const a = j.now();
      ((k.delta = z(0, 1e3 / 60, a - k.timestamp)),
        (k.timestamp = a),
        (k.isProcessing = !0),
        qt.update.process(k),
    ...
    removeElementScroll(r) {
      ...
      for (let l = 0; l < this.path.length; l++) {
        ...
        c !== this.root &&
          u &&
          h.layoutScroll &&
          (u.wasRoot && $(a, r), ct(a.x, u.offset.x), ct(a.y, u.offset.y));
      }
      return a;
    }
    applyTransform(r, a = !1) {
      ...
      for (let c = 0; c < this.path.length; c++) {
        ...
        (!a &&
          ...
          u.scroll &&
          u !== u.root &&
          ht(l, { x: -u.scroll.offset.x, y: -u.scroll.offset.y }),
        ...
        !(!this.relativeTarget && !this.targetDelta) &&
          ...
          this.relativeParent.target
            ? (this.forceRelativeParentToResolveTarget(),
              Dl(this.target, this.relativeTarget, this.relativeParent.target))
            : this.targetDelta
              ? (this.resumingFrom
    ...
    getClosestProjectingParent() {
      if (!(!this.parent || Ve(this.parent.latestValues) || Li(this.parent.latestValues)))
    ...
    createRelativeTarget(r, a, l) {
      ((this.relativeParent = r),
        ...
        _t(this.relativeTargetOrigin, a, l),
    ...
    calcProjection() {
      ...
      (!this.projectionDelta || !this.prevProjectionDelta
        ...
        : (as(this.prevProjectionDelta.x, this.projectionDelta.x),
          as(this.prevProjectionDelta.y, this.projectionDelta.y)),
        At(this.projectionDelta, this.layoutCorrected, d, this.latestValues),
        (this.treeScale.x !== h ||
          this.treeScale.y !== f ||
    ...
    createProjectionDeltas() {
      ((this.prevProjectionDelta = ft()),
        (this.projectionDelta = ft()),
        (this.projectionDeltaWithTransform = ft()));
    }
    setAnimationOrigin(r, a = !1) {
      ...
      const f = R(),
        ...
        T = !!(v && !p && this.options.crossfade === !0 && !this.path.some(vu));
      this.animationProgress = 0;
      let g;
      ((this.mixTargetDelta = (A) => {
        ...
        (Ts(h.x, r.x, P),
          ...
          this.relativeTarget &&
            ...
            (_t(f, this.layout.layoutBox, this.relativeParent.layout.layoutBox),
            yu(this.relativeTarget, this.relativeTargetOrigin, f, P),
            g && nu(this.relativeTarget, g) && (this.isProjectionDirty = !1),
            g || (g = R()),
            $(g, this.relativeTarget)),
          v && ((this.animationValues = u), ql(u, c, this.latestValues, P, T, p)),
    ...
    finishAnimation() {
      (this.currentAnimation &&
        (this.mixTargetDelta && this.mixTargetDelta(ru), this.currentAnimation.stop()),
    ...
    applyTransformsToTarget() {
      ...
      if (!(!a || !l || !c)) {
        if (
          ...
          this.layout &&
          c &&
          nr(this.options.animationType, this.layout.layoutBox, c.layoutBox)
        ) {
          l = this.target || R();
    ...
    applyProjectionStyles(r, a) {
      ...
      for (const m in we) {
        ...
        const { correct: v, applyTo: y, isCSSVariable: p } = we[m],
...
function nr(t, e, n) {
  return t === 'position' || (t === 'preserve-aspect' && !Ml(ms(e), ms(n), 0.2));
}
function Pu(t) {
...
const Su = er({
  ...
  bu = { pan: { Feature: $l }, drag: { Feature: Wl, ProjectionNode: sr, MeasureLayout: Yi } };
function As(t, e, n) {
  const { props: s } = t;
...
class Au extends J {
  mount() {
    ...
    e &&
      (this.unmount = Jo(e, (n, s) => (As(this.node, s, 'Start'), (i) => As(this.node, i, 'End'))));
  }
  unmount() {}
}
class wu extends J {
  ...
  mount() {
    ...
    e &&
      (this.unmount = na(
        e,
        (n, s) => (
          ws(this.node, s, 'Start'),
          (i, { success: o }) => ws(this.node, i, o ? 'End' : 'Cancel')
        ),
...
const Fu = {
  ...
  Bu = { layout: { ProjectionNode: sr, MeasureLayout: Yi } },
  Iu = { ...Sl, ...Fu, ...bu, ...Bu },
  Uu = Oa(Iu, Za);
export { Uu as m };
