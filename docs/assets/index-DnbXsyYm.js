const __vite__mapDeps = (
  ...
  d = m.f ||
    (m.f = [
      'assets/md-D7jQkBFc.js',
      'assets/index-cKcMP2r-.js',
      'assets/index-yCjjhCOA.css',
      'assets/playground-CqkUOrgq.js',
      'assets/六种继承方式-CAKcW3h5.js',
      'assets/虚拟列表-IzDf9tQ1.js'
    ])
) => i.map((i) => d[i]);
import {
  e as R,
...
import { C as O } from './index-Chq_vUlP.js';
import { u as P } from './useScrollRestore-zFj7vSmD.js';
import { d as x, C as S } from './data-BKVBUmT7.js';
/**
 ...
 */ const D = [
  ...
  v = Object.assign({
    '../../posts/md.mdx': () => _(() => import('./md-D7jQkBFc.js'), __vite__mapDeps([0, 1, 2])),
    '../../posts/playground.mdx': () =>
      _(() => import('./playground-CqkUOrgq.js'), __vite__mapDeps([3, 1, 2])),
    '../../posts/六种继承方式.mdx': () =>
      _(() => import('./六种继承方式-CAKcW3h5.js'), __vite__mapDeps([4, 1, 2])),
    '../../posts/虚拟列表.mdx': () =>
      _(() => import('./虚拟列表-IzDf9tQ1.js'), __vite__mapDeps([5, 1, 2]))
  }),
  j = {};
for (const r of Object.keys(v)) {
  const c = r.normalize('NFC').replace('../../posts/', '').replace('.mdx', '');
  j[c] = a.lazy(v[r]);
}
const U = () => {
  P();
  const { '*': r } = w(),
    ...
    d = a.useRef(null),
    u = a.useRef(null),
    [m, E] = a.useState(x.find((e) => e.path === r)),
    b = r ? j[decodeURIComponent(r).normalize('NFC')] : null;
  if (
    (a.useEffect(() => {
      const e = '/content/' + r;
      (E(x.find((o) => o.path === e)), console.log(m));
    }, [r]),
    a.useEffect(() => {
      if (!d.current) return;
      const e = () => {
        const n = Array.from(d.current.querySelectorAll('.prose h1,.prose h2,.prose h3')).map(
          (s) => ({
        ...
        (Array.from(d.current.querySelectorAll('.prose h1,.prose h2,.prose h3')).forEach((s, g) => {
          s.id || (s.id = n[g].id);
        }),
          N((s) => (s.length === n.length && s.every((g, f) => g.text === n[f].text) ? s : n)));
      };
      e();
    ...
    a.useEffect(() => {
      ...
      const e = new IntersectionObserver(
        (o) => {
          o.forEach((n) => {
            n.isIntersecting && p(n.target.id);
          });
        },
                ...
                t.jsxs('div', {
                  ...
                  children: [
                    t.jsxs('span', {
                      ...
                      children: [t.jsx(S, { style: { width: 16, height: 16 } }), ' ', m?.date]
                    }),
                    m?.tags.map((e, o) =>
              ...
              t.jsx('ul', {
                children: i.map((e) =>
                  t.jsx(
                    'li',
                    {
                      className: L(l['blog-outline-item'], { [l.active]: c === e.id }),
