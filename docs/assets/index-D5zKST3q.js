...
var s1;
function Js() {
  return (s1 || ((s1 = 1), (ei.exports = Ks())), ei.exports);
}
var Xn = Js(),
  ni = { exports: {} },
  be = {},
...
var h1;
function Ws() {
  return (h1 || ((h1 = 1), (fi.exports = ws())), fi.exports);
}
var ii = { exports: {} },
  C = {};
/**
...
function $s() {
  ...
  function wl(v) {
    return v === null || typeof v != 'object'
      ? null
      : ((v = (yl && v[yl]) || v['@@iterator']), typeof v == 'function' ? v : null);
  }
  var Bl = {
      isMounted: function () {
        return !1;
  ...
  function b(v, E, O, D, Y) {
    ...
    if (Tt(v))
      for (var ol = 0; ol < v.length; ol++)
        ((D = v[ol]), (Q = Cl + Ut(D, ol)), (k += b(D, E, O, Q, Y)));
    else if (((ol = wl(v)), typeof ol == 'function'))
      for (v = ol.call(v), ol = 0; !(D = v.next()).done; )
        ((D = D.value), (Q = Cl + Ut(D, ol++)), (k += b(D, E, O, Q, Y)));
    else if (Q === 'object') {
...
var S1;
function E1() {
  return (S1 || ((S1 = 1), (ii.exports = $s())), ii.exports);
}
var yi = { exports: {} },
  pl = {};
/**
...
function ks() {
  ...
  return (U(), (yi.exports = Fs()), yi.exports);
}
/**
 * @license React
...
` +
  ...
  var Vn = Object.prototype.hasOwnProperty,
    ...
    _1 = U.unstable_shouldYield,
    O1 = U.unstable_requestPaint,
    $l = U.unstable_now,
    M1 = U.unstable_getCurrentPriorityLevel,
    si = U.unstable_ImmediatePriority,
    di = U.unstable_UserBlockingPriority,
    Te = U.unstable_NormalPriority,
    D1 = U.unstable_LowPriority,
    hi = U.unstable_IdlePriority,
    r1 = U.log,
    U1 = U.unstable_setDisableYieldValue,
    Ma = null,
    Fl = null;
  function Wt(l) {
    if ((typeof r1 == 'function' && U1(l), Fl && typeof Fl.setStrictMode == 'function'))
      try {
  ...
  if (pt) {
    ...
    if (pt) {
      ...
      if (!sf) {
        ...
        ($i.setAttribute('oninput', 'return;'), (sf = typeof $i.oninput == 'function'));
      }
      mf = sf;
    } else mf = !1;
  ...
  function Qe(l, t, u, a, e, n) {
    ...
    if (((a = l), typeof l == 'function')) Tf(l) && (f = 1);
      ...
      f = qs(l, u, D.current) ? 26 : l === 'html' || l === 'head' || l === 'body' ? 27 : 5;
    else
      l: switch (l) {
        case Et:
  ...
  function yt(l, t) {
    if (typeof l == 'object' && l !== null) {
      var u = s0.get(l);
      return u !== void 0 ? u : ((t = { value: l, source: t, stack: mi(t) }), s0.set(l, t), t);
    }
  ...
  function o0(l) {
    ...
    switch (((t[Ml] = l), (t[jl] = a), u)) {
      ...
      case 'input':
        (Z('invalid', t),
          Ui(t, a.value, a.defaultValue, a.checked, a.defaultChecked, a.type, a.name, !0));
        break;
      case 'select':
        Z('invalid', t);
        break;
      case 'textarea':
        (Z('invalid', t), Ni(t, a.value, a.defaultValue, a.children));
    }
    ((u = a.children),
  ...
  function ua(l) {
    ...
    if (
      ...
      t === 27
        ...
        : (cl = Dl ? ht(l.stateNode.nextSibling) : null);
    return !0;
  }
  function Uu() {
    ((cl = Dl = null), (K = !1));
  ...
  var Hm =
    ...
    Nm = U.unstable_scheduleCallback,
  ...
  function M0(l) {
    ...
    function g(m, y, s, z, H) {
      return y === null || y.tag !== 7
        ? ((y = ru(s, m.mode, z, H)), (y.return = m), y)
        : ((y = e(y, s)), (y.return = m), y);
    }
    function T(m, y, s) {
    ...
    function M(m, y, s, z) {
      ...
      if (r === null) {
        for (; G < s.length; G++)
          ((r = T(m, s[G], z)),
            r !== null && ((y = n(r, y, G)), J === null ? (H = r) : (J.sibling = r), (J = r)));
        return (K && qt(m, G), H);
      }
      for (r = a(r); G < s.length; G++)
        ((x = S(r, m, G, s[G], z)),
          x !== null &&
            (l && x.alternate !== null && r.delete(x.key === null ? G : x.key),
            (y = n(x, y, G)),
    ...
    function p(m, y, s, z) {
      ...
      for (
        var H = null, J = null, r = y, G = (y = 0), x = null, w = s.next();
        r !== null && !w.done;
        G++, w = s.next()
      ) {
        r.index > G ? ((x = r), (r = null)) : (x = r.sibling);
      ...
      if (r === null) {
        for (; !w.done; G++, w = s.next())
          ((w = T(m, w.value, z)),
            w !== null && ((y = n(w, y, G)), J === null ? (H = w) : (J.sibling = w), (J = w)));
        return (K && qt(m, G), H);
      }
      for (r = a(r); !w.done; G++, w = s.next())
        ((w = S(r, m, G, w.value, z)),
          w !== null &&
            (l && w.alternate !== null && r.delete(w.key === null ? G : w.key),
            (y = n(w, y, G)),
            J === null ? (H = w) : (J.sibling = w),
            (J = w)));
      return (
  ...
  function Vf(l, t, u, a, e, n) {
    return (
      ...
      (t.updateQueue = null),
      (t.lanes = 0),
      (b.H = l === null || l.memoizedState === null ? dy : ac),
      (Yu = !1),
      (n = u(a, e)),
      (Yu = !1),
      ya && (n = R0(t, u, a, e)),
  ...
  function $a(l) {
    ...
    return (
      ...
      (zl === null ? t.memoizedState : zl.next) === null &&
        ((t = t.alternate), (b.H = t === null || t.memoizedState === null ? dy : ac)),
      l
    );
  }
  function Pe(l) {
  ...
  function Zm(l, t, u) {
    ...
    ((u = {
      ...
      an(l) ? my(t, u) : ((u = zf(l, t, u, a)), u !== null && (Jl(u, l, a), sy(u, t, a))));
  }
  function vy(l, t, u) {
    var a = et();
    Fa(l, t, u, a);
      ...
      if (
        ...
        try {
          ...
          if (((e.hasEagerState = !0), (e.eagerState = c), Il(c, f)))
            return (Ge(l, t, e, 0), fl === null && Be(), !1);
        } catch {
        } finally {
        }
      if (((u = zf(l, t, e, a)), u !== null)) return (Jl(u, l, a), sy(u, t, a), !0);
    }
    return !1;
  }
  function uc(l, t, u, a) {
  ...
  var dy = {
    ...
    ac = {
      ...
      useDeferredValue: function (l, t) {
        var u = gl();
        return ey(u, ul.memoizedState, l, t);
      },
      useTransition: function () {
        var l = ln(Gt)[0],
          t = gl().memoizedState;
  ...
  var hy = {
    ...
    useDeferredValue: function (l, t) {
      var u = gl();
      return ul === null ? Pf(u, l, t) : ey(u, ul.memoizedState, l, t);
    },
    useTransition: function () {
      var l = Wf(Gt)[0],
        t = gl().memoizedState;
  ...
  function Ry(l, t, u) {
    ...
    if (i !== null && ((c = i.dehydrated), c !== null)) {
      if (n)
        ...
        if (((f = fl), f !== null && ((a = bi(f, u)), a !== 0 && a !== i.retryLane)))
  ...
  function Yy(l, t, u) {
    if (l !== null)
      if (l.memoizedProps !== t.pendingProps) Tl = !0;
        ...
        if (!oc(l, u) && (t.flags & 128) === 0) return ((Tl = !1), Lm(l, t, u));
        Tl = (l.flags & 131072) !== 0;
      }
    else ((Tl = !1), K && (t.flags & 1048576) !== 0 && d0(t, Qa, t.index));
    switch (((t.lanes = 0), t.tag)) {
      ...
      case 27:
        return (
          ...
          l === null &&
            K &&
            ((a = t.stateNode = xv(t.type, t.pendingProps, Q.current)),
            (Dl = t),
            (st = !0),
            (e = cl),
        ...
        return (
          l === null &&
            ...
            ((e = a = cl) &&
              ...
              a !== null
                ? ((t.stateNode = a), (Dl = t), (cl = ht(a.firstChild)), (st = !1), (e = !0))
                : (e = !1)),
            e || Pt(t)),
          Oa(t),
          (e = t.type),
          ...
          t.memoizedState !== null && ((e = Vf(l, t, Ym, null, null, u)), (de._currentValue = e)),
          fn(l, t),
          Ul(l, t, a, u),
          t.child
        );
        ...
        return (
          l === null &&
            ...
            ((l = u = cl) &&
              ...
              u !== null ? ((t.stateNode = u), (Dl = t), (cl = null), (l = !0)) : (l = !1)),
            l || Pt(t)),
          null
        );
      case 13:
            ...
            : ((l.lanes & u) !== 0 && (Yf(l, t), wa(t, null, null, u), Ja()),
              ...
              e.parent !== a
                ? ((e = { parent: a, cache: a }),
                  ...
                  lu(t, bl, a))
                : ((a = n.cache), lu(t, bl, a), a !== e.cache && Hf(t, [bl], u, !0))),
          Ul(l, t, t.pendingProps.children, u),
          t.child
        );
      case 29:
  ...
  function Km(l, t, u) {
    ...
    switch ((Of(t), t.tag)) {
      ...
      case 26:
        ...
        return (
          l === null
            ? (Qt(t), n !== null ? (il(t), By(t, n)) : (il(t), Sc(t, e, null, a, u)))
            : n
              ? n !== l.memoizedState
                ? (Qt(t), il(t), By(t, n))
                : (il(t), (t.flags &= -16777217))
              : ((l = l.memoizedProps), l !== a && Qt(t), il(t), Sc(t, e, l, a, u)),
          null
        );
      case 27:
        if ((ze(t), (u = Q.current), (e = t.type), l !== null && t.stateNode != null))
          ...
          ((l = D.current), ua(t) ? o0(t) : ((l = xv(e, a, u)), (t.stateNode = l), Qt(t)));
        }
        return (il(t), null);
      case 5:
        ...
        return (il(t), Sc(t, t.type, l === null ? null : l.memoizedProps, t.pendingProps, u), null);
      case 6:
  ...
  var jt = !1,
    ...
    Ol = null;
  function wm(l, t) {
    if (((l = l.containerInfo), (Zc = pn), (l = t0(l)), df(l))) {
    ...
    for (Vc = { focusedElem: l, selectionRange: u }, pn = !1, Ol = t; Ol !== null; )
    ...
    switch (u.tag) {
      ...
      case 13:
        (Vt(l, u),
          ...
          a & 64 &&
            ((l = u.memoizedState),
            l !== null && ((l = l.dehydrated), l !== null && ((u = us.bind(null, u)), As(l, u)))));
        break;
      case 22:
  ...
  function Iy(l, t, u) {
    switch (l.tag) {
      case 26:
        (da(l, t, u),
          l.flags & ae && l.memoizedState !== null && Cs(u, bt, l.memoizedState, l.memoizedProps));
        break;
      case 5:
        da(l, t, u);
        break;
  ...
  var $m = {
    ...
    Uc = null;
  function et() {
    return ($ & 2) !== 0 && V !== 0 ? V & -V : b.T !== null ? Cc() : zi();
  }
  function ev() {
    if (at === 0)
      if ((V & 536870912) === 0 || K) {
  ...
  function Jl(l, t, u) {
    (((l === fl && (I === 2 || I === 9)) || l.cancelPendingCommit !== null) &&
      ...
      ra(l, u),
      (($ & 2) === 0 || l !== fl) &&
        (l === fl && (($ & 2) === 0 && (Xu |= u), sl === 4 && mu(l, V, at, !1)), Dt(l)));
  }
  function nv(l, t, u) {
      ...
      if (e === 0) {
        ...
        l: {
          ...
          if ((t & 62914560) === t && ((e = dn + 300 - $l()), 10 < e)) {
            ...
            ((Kt = t),
              (a.timeoutHandle = Bv(
                fv.bind(null, a, u, Kl, on, Mc, t, at, Xu, oa, cu, n, 'Throttled', -0, 0),
                e
              )));
            break l;
          }
          fv(a, u, Kl, on, Mc, t, at, Xu, oa, cu, n, null, -0, 0);
        }
      }
      break;
    } while (!0);
  ...
  function fv(l, t, u, a, e, n, f, c, i, d, g, T, h, S) {
    if (((l.timeoutHandle = -1), (T = t.subtreeFlags), T & 8192 || (T & 16785408) === 16785408)) {
      ((T = {
        ...
        Iy(t, n, T));
      var M = (n & 62914560) === n ? dn - $l() : (n & 4194048) === n ? uv - $l() : 0;
      if (((M = Ys(T, M)), M !== null)) {
        ((Kt = n),
        ...
        if (I !== 0 && j !== null) {
          ...
          t: switch (I) {
            ...
            case 4:
              ...
              break l;
            case 7:
              E0(n) ? ((I = 0), (ut = null), sv(t)) : ((I = 0), (ut = null), ba(l, t, n, 7));
              break;
            case 5:
              var f = null;
              switch (j.tag) {
  ...
  function sv(l) {
    ...
    switch (t.tag) {
      case 15:
      case 0:
        t = Hy(u, t, t.pendingProps, t.type, void 0, V);
        break;
      case 11:
        t = Hy(u, t, t.pendingProps, t.type.render, t.ref, V);
        break;
      case 5:
        Kf(t);
      default:
        (Gy(u, t), (t = j = v0(t, Lt)), (t = Yy(u, t, Lt)));
    }
    ((l.memoizedProps = l.pendingProps), t === null ? bn(l) : (j = t));
  }
  function ba(l, t, u, a) {
  ...
  function gv() {
    if (Al === 4 || Al === 3) {
      ...
      (t.subtreeFlags & 10256) !== 0 || (t.flags & 10256) !== 0
        ? (Al = 5)
        : ((Al = 0), (Sa = vu = null), bv(l, l.pendingLanes));
  ...
  function pc(l, t, u) {
    ...
    e.has(u) || ((_c = !0), e.add(u), (l = ts.bind(null, l, t, u)), t.then(l, l));
  }
  function ts(l, t, u) {
    var a = l.pingCache;
    (a !== null && a.delete(t),
  ...
  function Ev(l, t) {
    (t === 0 && (t = oi()), (l = Du(l, t)), l !== null && (ra(l, t), Dt(l)));
  }
  function us(l) {
    var t = l.memoizedState,
      u = 0;
      ...
      if ((t & 7) === 0) {
        l: {
          if (
            ...
            h && u !== lf && (M = u.relatedTarget || u.fromElement) && (Zu(M) || M[ju]))
          )
            break l;
          if (
            (S || h) &&
            ...
            S
              ? ((M = u.relatedTarget || u.toElement),
                ...
                (M = M ? Zu(M) : null),
                M !== null &&
                  ((el = W(M)), (p = M.tag), M !== el || (p !== 5 && p !== 27 && p !== 6)) &&
                  (M = null))
              : ((S = null), (M = d)),
            S !== M)
          ) {
            ...
            (S !== null && Nv(T, h, S, p, !1), M !== null && el !== null && Nv(T, el, M, p, !0));
          }
        }
        l: {
          if (
        ...
        switch (((r = d ? Ha(d) : window), l)) {
          case 'focusin':
            (Ki(r) || r.contentEditable === 'true') && ((Fu = r), (hf = d), (Xa = null));
            break;
          case 'focusout':
            Xa = hf = Fu = null;
            break;
        ...
        (x &&
          (ji &&
            ...
            ($u || x !== 'onCompositionStart'
              ? x === 'onCompositionEnd' && $u && (G = Yi())
              : ((Ft = g), (ef = 'value' in Ft ? Ft.value : Ft.textContent), ($u = !0))),
          (r = _n(d, x)),
          0 < r.length &&
            ((x = new Xi(x, l, null, u, g)),
            T.push({ event: x, listeners: r }),
            G ? (x.data = G) : ((G = Li(u)), G !== null && (x.data = G)))),
          (G = hm ? om(l, u) : Sm(l, u)) &&
...
`
  ...
  function Hl(l, t, u) {
    switch (t) {
      ...
      default:
        if (Pn(t)) {
          for (g in u)
            u.hasOwnProperty(g) && ((a = u[g]), a !== void 0 && jc(l, t, g, a, u, void 0));
          return;
        }
    }
        ...
        if (n && c && qv(f)) {
          for (f = 0, c = e.responseEnd, a += 1; a < u.length; a++) {
            ...
            var g = i.transferSize,
              T = i.initiatorType;
            g && qv(T) && ((i = i.responseEnd), (f += g * (i < c ? 1 : (c - d) / (i - d))));
          }
  ...
  var Bv = typeof setTimeout == 'function' ? setTimeout : void 0,
    ...
    bs =
      typeof queueMicrotask == 'function'
        ...
        : typeof Gv < 'u'
          ? function (l) {
              return Gv.resolve(null).then(l).catch(zs);
            }
          : Bv;
  function zs(l) {
    setTimeout(function () {
  ...
  function $v(l, t, u) {
    ...
    for (a.set(l, null), u = u.getElementsByTagName(l), e = 0; e < u.length; e++) {
      var n = u[e];
      if (
        !(n[Ua] || n[Ml] || (l === 'link' && n.getAttribute('rel') === 'stylesheet')) &&
        n.namespaceURI !== 'http://www.w3.org/2000/svg'
      ) {
  ...
  function Nn(l, t) {
    ((l.stylesheets = null),
      l.unsuspend !== null &&
        (l.count++, (Hn = new Map()), t.forEach(Bs, l), (Hn = null), Un.call(l)));
  }
  function Bs(l, t) {
  ...
  function Iv(l, t, u, a, e, n, f, c, i, d, g, T) {
    return (
  ...
  function Pc(l, t, u, a) {
    if (pn) {
      var e = li(a);
      if (e === null) (Qc(l, t, a, Rn, u), n1(l, a));
      else if (Zs(e, l, t, u, a)) a.stopPropagation();
      else if ((n1(l, a), t & 4 && -1 < js.indexOf(l))) {
        for (; e !== null; ) {
          var n = Vu(e);
          if (n !== null)
            switch (n.tag) {
  ...
  function Cn(l, t) {
    l.blockedOn === t &&
      ((l.blockedOn = null),
      ui || ((ui = !0), U.unstable_scheduleCallback(U.unstable_NormalPriority, Vs)));
  }
  var Yn = null;
  function i1(l) {
    Yn !== l &&
  ...
  ((Bn.prototype.render = ai.prototype.render =
    function (l) {
    ...
    (Bn.prototype.unmount = ai.prototype.unmount =
      function () {
  ...
  var v1 = dl.version;
  if (v1 !== '19.2.0') throw Error(o(527, v1, '19.2.0'));
...
function Ps() {
  ...
  return (U(), (ni.exports = Is()), ni.exports);
}
var ld = Ps();
function td() {
  return Xn.jsx(Xn.Fragment, { children: Xn.jsx('h1', { children: 'hello world' }) });
}
ld.createRoot(document.getElementById('root')).render(Xn.jsx(td, {}));
