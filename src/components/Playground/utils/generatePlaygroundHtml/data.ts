...
export const IMPORT_REACT_MAP: Record<string, string> = {
  ...
  "react-router-dom":
    "https://esm.sh/react-router-dom@6?dev&external=react,react-dom",
  zustand:
    "https://esm.sh/zustand@4.5.7?dev&external=react,react-dom,use-sync-external-store",
  "zustand/middleware":
    "https://esm.sh/zustand@4.5.7/middleware?dev&external=react,react-dom,use-sync-external-store",
  "zustand/vanilla":
    "https://esm.sh/zustand@4.5.7/vanilla?dev&external=react,react-dom",
